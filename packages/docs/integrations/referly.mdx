...
<Frame caption="The tracking script step in Referly, with the copyable snippet and the install check.">
  <img
    style={{ borderRadius: "0.5rem" }}
    src="/images/referly/tracking-script.png"
    alt="Referly's tracking script panel with the copyable script snippet and a Verify button"
  />
</Frame>
